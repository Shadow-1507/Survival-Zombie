...
namespace Survival_Zom
{
    ...
    internal class Program
    {
        ...
        /// Hàm cập nhật state
        /// </summary>
        /// <param name="playerHp"> máu player</param>
        /// <param name="day">số ngày sinh tồn</param>
        static PlayerState UpdateState(int playerHp, int day)
        {
            if (playerHp == 0)
            {
            ...
            if (playerHp >= 70)
            {
                return PlayerState.LightlyInjured;
            }

            if (playerHp >= 50)
            {
                return PlayerState.DeepWound;
            }

            if (playerHp >= 30)
            {
                return PlayerState.SeriousWound;
            }

            return PlayerState.DangerousBloodThreshold;
        }
        static void Main(string[] args)
        {
            ...
            int water = 5;
            int medkit = 0;
            PlayerState state = PlayerState.Healthy;
            int day = 1;
            ...
            while (state != PlayerState.Dead)
            {
                ...
                switch (playerChoose)
                {
                    case 1:
                        ...
                        state = UpdateState(playerHp, day);
